    ...
    <div class="auth-wrapper" :style="'height: ' + windowHeight + 'px'">
        <div  class="auth-form text-center">
            ...
            <div v-else>
                ...
                <router-link to="/teacher/resetpassword" class="mt-5" style="display: block">
    ...
    export default {
        ...
        methods: {
            ...
            resetPassword(){
                ...
                var _this = this;
                axios.post(this.$serverURL + '/teacher/reset_password', {phone: this.phone, password: encodePass, newpassword: encodeNewPass})
                    .then(function (response) {
                        response = response.data;
                        // console.log(response)
                        if(response.success){
