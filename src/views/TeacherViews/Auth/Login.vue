    ...
    <div class="auth-wrapper" :style="'height: ' + windowHeight + 'px'">
        <div  class="auth-form text-center">
            ...
            <div class="row fn-11 fn-info pl-2 pr-2 pt-3 pb-3">
                <router-link to="/teacher/register" class="col-6 text-left">注册账号</router-link>
                <router-link v-if="!selectedTabID" to="/teacher/resetpassword" class="col-6 text-right">忘记密码</router-link>
            </div>
    ...
    export default {
        ...
        methods: {
            ...
            verificatePhone(){
                ...
                var _this = this;
                axios.post(this.$serverURL + '/sms_auth/2', {phone: this.phone})
            ...
            userLogin(){
                ...
                var _this = this
                axios.post(this.$serverURL + '/teacher/login', loginData)
                    .then(function (response) {
